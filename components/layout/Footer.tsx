...
export default function Footer() {
  return (
    <footer className="bg-deep-teal text-white mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-light-mint/80 text-sm">
              AI-powered oral exams made simple for every teacher
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/privacy" className="text-light-mint/80 hover:text-light-mint transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-light-mint/80 hover:text-light-mint transition-colors">Terms of Service</Link></li>
              <li><Link href="/security" className="text-light-mint/80 hover:text-light-mint transition-colors">Security</Link></li>
            </ul>
          </div>
        </div>

        {/* Bottom Bar */}
        <div className="border-t border-light-mint/20 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-light-mint/60 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Examly. All rights reserved.
          </p>
          
          {/* Social Icons */}
          <div className="flex space-x-4">
            <Link href="#" className="text-light-mint/60 hover:text-light-mint transition-colors">
