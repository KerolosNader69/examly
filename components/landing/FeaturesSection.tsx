...
export default function FeaturesSection() {
  return (
    <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-deep-teal">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <ScrollReveal>
            <div className="bg-bg-light dark:bg-dark-surface rounded-card-lg border border-primary-teal/20 shadow-sm p-6 flex flex-col h-full transition-all duration-200 hover:-translate-y-1 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold font-poppins text-deep-teal dark:text-white mb-2">
                AI-Powered Grading
              </h3>
              <p className="text-sm text-text-dark/70 dark:text-light-mint/70 mb-6 flex-grow">
              ...
              <div className="mt-auto bg-white dark:bg-dark-surface rounded-card h-32 border border-primary-teal/10 relative overflow-hidden flex items-center justify-center">
          ...
          <ScrollReveal>
            <div className="bg-bg-light dark:bg-dark-surface rounded-card-lg border border-primary-teal/20 shadow-sm p-6 flex flex-col h-full transition-all duration-200 hover:-translate-y-1 hover:shadow-xl">
              ...
              <p className="text-sm text-text-dark/70 dark:text-light-mint/70 flex-grow">
        ...
        <ScrollReveal>
          <div className="bg-bg-light dark:bg-dark-surface rounded-card-lg border border-primary-teal/20 shadow-sm p-6 flex flex-col transition-all duration-200 hover:-translate-y-1 hover:shadow-xl">
            <div className="w-12 h-12 rounded-card bg-light-mint/30 flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-primary-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
